...
- [Hvad er personoplysninger](https://www.datatilsynet.dk/hvad-siger-reglerne/grundlaeggende-begreber/)- 
- [Hvad er GDPR? - Datatilsynet]()
- [GDPR forklaret - Forbrugerrådet Tænk](https://taenk.dk/forbrugerliv/elektronik-og-digitale-tjenester/gdpr-saadan-faar-du-kontrol-med-dine-data)
- [Forskelle mellem GDPR og amerikansk lovgivning](https://iapp.org/news/a/summary-of-key-differences-between-gdpr-and-u-s-privacy-laws/)

**Videoer om emnet**

- [Hvad er GDPR?](https://www.youtube.com/watch?v=5ZhMlZ9yGz8)
- [GDPR Explained](https://www.youtube.com/watch?v=DpyLrprE91U)
- [GDPR for Beginners](https://www.youtube.com/watch?v=ZbI5Emi1Urs)

**Infografiske illustrationer**

- [Infografik: GDPRs hovedprincipper](https://ico.org.uk/media/about-the-ico/images-and-infographics/2618976/gdpr-principles-infographic.png)
- [Infografik: Hvordan GDPR beskytter dine data](https://dataprotection.ie/sites/default/files/uploads/images/GDPR_Principles.jpg)
- [Infografik: Forskelle mellem GDPR og andre databeskyttelseslove](https://compliancekitchen.com/wp-content/uploads/2018/05/GDPR-vs-US-Laws.png)

**Opgave med 10 spørgsmål**

1. Hvad står GDPR for, og hvornår trådte det i kraft?
2. Hvad er en personoplysning? Giv tre eksempler.
3. Hvad kræves for at indsamle personoplysninger under GDPR?
4. Hvad er en databehandleraftale?
5. Hvordan adskiller GDPR sig fra amerikanske databeskyttelseslove?
6. Hvordan kan borgere få indsigt i, hvilke data der indsamles om dem?
7. Hvad betyder "retten til at blive glemt"?
8. Hvilken rolle spiller samtykke i GDPR?
9. Nævn to konsekvenser for virksomheder, der ikke overholder GDPR.
10. Diskutér, hvordan GDPR påvirker din hverdag som internetbruger.

**Tre takeaways**

- GDPR beskytter borgernes ret til privatliv og kontrol over deres egne data.
- Virksomheder skal indhente klart samtykke for at indsamle og bruge personoplysninger.
- Forskelle mellem EU og USA viser, hvordan databeskyttelse prioriteres forskelligt globalt.

## 3.2 Cookies
**Introduktion til emnet**

Cookies er små tekstfiler, som lagres på din computer, smartphone eller tablet, når du besøger en hjemmeside. De har forskellige funktioner og kan inddeles i fire hovedtyper:

- **Tekniske cookies**: Disse er nødvendige for, at hjemmesiden fungerer korrekt. De husker fx dine loginoplysninger eller varer i din indkøbskurv.
- **Statistikcookies**: Anvendes til at optimere design, brugervenlighed og effektiviteten af en hjemmeside ved at indsamle oplysninger om, hvilke sider der er mest populære.
- **Personaliserede cookies**: Også kendt som trackingcookies, de følger din færden på nettet og bruges til at give dig mere målrettet og relevant indhold, såsom foreslåede artikler eller produkter.
- **Markedsføringscookies**: Bruges i kommercielt øjemed til at målrette annoncer baseret på din online adfærd og interesser.

Det er vigtigt at forstå disse forskellige typer af cookies, da de påvirker din online oplevelse og privatliv på forskellige måder.

**Guide til at se sine cookies i Chrome**

1. Åbn Chrome-browseren.
2. Klik på de tre prikker i øverste højre hjørne for at åbne menuen.
3. Vælg "Indstillinger" i menuen.
4. Scroll ned og klik på "Sikkerhed og privatliv" i venstre side.
5. Klik på "Cookies og andre webstedsdata".
6. Under "Alle cookies og webstedsdata" kan du se en liste over gemte cookies fra forskellige hjemmesider.
7. Du kan klikke på hver enkelt hjemmeside for at se detaljerede oplysninger om de cookies, der er gemt.
...
- [What is the Difference Between Authentication and Authorization?](https://www.okta.com/identity-101/authentication-vs-authorization/)
- [Understanding Authentication and Authorization](https://www.csoonline.com/article/3573644/authentication-and-authorization-whats-the-difference.html)

**Videoer om emnet**

- [Authentication vs. Authorization Explained](https://www.youtube.com/watch?v=LU-KqmpZBT0)
- [What is Authentication and Authorization?](https://www.youtube.com/watch?v=7N2f5gJZxyo)
- [Authentication and Authorization in 5 Minutes](https://www.youtube.com/watch?v=12345)

**Infografiske illustrationer**

- [Authentication and Authorization Flow](https://miro.medium.com/v2/resize:fit:640/format:webp/1*w4cLpXJPfVV-mLDDU7pLbw.png)
...
Kryptering er en metode til at beskytte data ved at omdanne dem til en uforståelig kode, som kun kan dekrypteres med den rette nøgle. Kryptering bruges bredt i moderne teknologi for at sikre privatliv og datasikkerhed. Nogle eksempler inkluderer:

- **HTTPS**: Websites, der bruger HTTPS, krypterer al kommunikation mellem brugeren og serveren for at beskytte mod aflytning.
- **End-to-end kryptering**: Anvendes i apps som WhatsApp og Signal, hvor kun afsender og modtager kan læse beskederne.
- **VPN**: Virtuelle private netværk krypterer din internetforbindelse, så din online aktivitet forbliver privat.

Kryptering spiller en central rolle i at beskytte data mod uautoriseret adgang og sikrer, at følsomme oplysninger forbliver private.
...
1. Hvad er kryptering, og hvorfor er det vigtigt?
2. Hvordan fungerer HTTPS?
3. Hvad betyder end-to-end kryptering, og hvordan beskytter det brugeren?
4. Hvordan hjælper en VPN med at beskytte dine data?
5. Hvad er forskellen mellem kryptering og hashing?
6. Hvorfor er kryptering afgørende for moderne teknologi?
7. Hvordan kan kryptering beskytte dig mod man-in-the-middle-angreb?
8. Hvad skal man kigge efter for at sikre, at en hjemmeside bruger HTTPS?
9. Hvilke ulemper kan der være ved brugen af kryptering?
10. Diskutér, hvordan kryptering kan balancere privatliv og offentlig sikkerhed.

**Tre takeaways**

- Kryptering er afgørende for at beskytte data og privatliv online.
- HTTPS og end-to-end kryptering er centrale teknologier for sikker kommunikation.
- VPN kan hjælpe med at beskytte din online aktivitet mod uønsket overvågning.
